...
class HelpScreen(ModalScreen[None]):
    BINDINGS = [
        ...
        Binding("alt+h", "go_back", "M-h back"),
    ]
...
[bold {C_CYAN}]Navigation[/bold {C_CYAN}]
  ...
  [{C_YELLOW}]Alt+L[/{C_YELLOW}]            Drill in / resume session
  [{C_YELLOW}]Alt+H[/{C_YELLOW}]            Back / close
...
class QuickNoteScreen(ModalScreen[str | None]):
    BINDINGS = [Binding("alt+h", "go_back", "M-h back")]
    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="qnote-container"):
            ...
            yield Static(f"[{C_DIM}]Enter[/{C_DIM}] save  [{C_DIM}]M-h[/{C_DIM}] back", id="qnote-hint")
...
class _TodoEditScreen(ModalScreen[str | None]):
    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="todo-edit-container"):
            ...
            yield Static(f"[{C_DIM}]Enter[/{C_DIM}] save  [{C_DIM}]M-h[/{C_DIM}] back", id="todo-edit-hint")
...
class _TodoContextScreen(ModalScreen[None]):
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(id="todo-ctx-container"):
            ...
            yield Static(f"[{C_DIM}]M-h[/{C_DIM}] save & back", id="todo-ctx-hint")
...
class LinksScreen(_VimOptionListMixin, ModalScreen[None]):
    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="links-container"):
            ...
            yield Static(f"[{C_DIM}]Enter[/{C_DIM}] open  [{C_DIM}]M-h[/{C_DIM}] back", id="links-hint")
...
class AddScreen(ModalScreen[Workstream | None]):
    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="add-container"):
            ...
            yield Static(f"[{C_DIM}]Enter[/{C_DIM}] create  [{C_DIM}]M-h[/{C_DIM}] back", id="add-hint")
...
class DetailScreen(_VimOptionListMixin, ModalScreen[None]):
    BINDINGS = [
        Binding("alt+h", "go_back", "M-h back"),
        Binding("alt+l", "go_forward", "M-l resume"),
    ...
    def _update_help_bar(self):
        ...
        if search_input.has_class("visible") and not search_input.has_focus:
            ...
            pairs = [
                ("j/k", "navigate"), ("M-l", "resume"),
                ("/", "refine"), ("M-h", "clear/back"),
            ]
...
class BrainDumpScreen(ModalScreen[str | None]):
    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="brain-container"):
            ...
            yield Static(f"[{C_DIM}]Ctrl+S[/{C_DIM}] submit  [{C_DIM}]M-h[/{C_DIM}] back", id="brain-hint")
...
class BrainPreviewScreen(ModalScreen[bool]):
    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="brain-preview-container"):
            ...
            yield Rule()
            yield Static(f"[{C_DIM}]Enter/y[/{C_DIM}] add all  [{C_DIM}]Esc/n[/{C_DIM}] cancel  [{C_DIM}]M-h[/{C_DIM}] back", id="brain-preview-hint")
...
class AddLinkScreen(ModalScreen[Link | None]):
    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="addlink-container"):
            ...
            yield Static(f"[{C_DIM}]Enter[/{C_DIM}] add  [{C_DIM}]M-h[/{C_DIM}] back", id="addlink-hint")
...
class LinkSessionScreen(_VimOptionListMixin, ModalScreen[Workstream | None]):
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(id="linksession-container"):
            ...
            yield Static(f"[{C_DIM}]Enter[/{C_DIM}] link  [{C_DIM}]M-h[/{C_DIM}] back", id="linksession-hint")
...
class SessionPickerScreen(_VimOptionListMixin, ModalScreen[ClaudeSession | None]):
    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="threadpick-container"):
            ...
            yield Static(
                f"[{C_DIM}]Enter[/{C_DIM}] resume  [{C_DIM}]M-h[/{C_DIM}] back",
                id="threadpick-hint",
            )
...
class RepoPickerScreen(_VimOptionListMixin, ModalScreen[str | None]):
    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="repopick-container"):
            ...
            yield Static(
                f"[{C_DIM}]Enter[/{C_DIM}] select  [{C_DIM}]M-h[/{C_DIM}] back",
                id="repopick-hint",
            )
...
class ConfirmScreen(ModalScreen[bool]):
    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="confirm-container"):
            ...
            yield Static(f"[{C_DIM}]y[/{C_DIM}] yes  [{C_DIM}]n[/{C_DIM}] no  [{C_DIM}]M-h[/{C_DIM}] back", id="confirm-hint")
